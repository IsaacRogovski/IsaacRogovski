...
## 🛠️ Technologies: 
[![My Skills](https://skillicons.dev/icons?i=html,css,js,jquery,bootstrap,cs,php,mysql,linux,debian,git,github)](https://skillicons.dev)


## 📚 Currently Learning

- C# (focused on logic and system development)
- Linux Debian (terminal, package management, automation)
